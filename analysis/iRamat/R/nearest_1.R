...
df <- read.xlsx(paste0(pathFolder, fileTauxInc))
...
# Plot
gnnd <- ggplot(df.sorted, aes(x = X_class, y = mean_nnd, group = 1)) +
...
fileOut <- paste0(pathFolder, "My_Graph.jpg")
ggsave(fileOut, plot = gnnd, width = 18, height = 12)
